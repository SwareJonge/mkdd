...
//         // Call viewCalc on the model
//         pModel->setCurrentViewNo(viewNo);
        
//         // Check if model should be drawn
//         if ((pModel->getFlags() & 0xF) != 0 && pModel->getFlag95() != 0) {
//             J3DModelData* pModelData = pModel->getModel()->getModelData();
//             u16 numShapes = pModelData->getShapeNum();
//             J3DModel* pJ3DModel = pModel->getModel();
...
//                 J3DShapePacket* pShapePacket = pJ3DModel->getShapePacket(i);
//                 pShapePacket->draw();
//             }
...
//             // Set material color
//             JUTColor chanColor(0, 0, 0, alphaValue);
//             GXSetChanMatColor(GX_ALPHA1, chanColor);
...
//     // Iterate through shadow models in list
//     for (List::iterator it = modelList.begin(); it != List::const_iterator(modelList.end()); ++it) {
...
//     // CRITICAL: Store end iterator as a separate named variable like Sunshine does
//     List::iterator it, itEnd;

//     // Iterate through shadow models in list
//     for (it = modelList.begin(), itEnd = modelList.end(); it != itEnd; ++it) {
...
//     List::iterator itEnd = modelList.end();
