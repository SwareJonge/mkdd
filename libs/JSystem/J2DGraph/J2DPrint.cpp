...
J2DPrint::J2DPrint(JUTFont* font, JUTColor charColor, JUTColor gradColor)
{
    private_initiate(font, 0.0f, 0.0f, charColor, gradColor, TCOLOR_BLACK_U32, TCOLOR_WHITE_U32, true);
}

J2DPrint::J2DPrint(JUTFont* font, f32 width, f32 height, JUTColor charColor, JUTColor gradColor,
                   JUTColor blackColor, JUTColor whiteColor)
{
...
void J2DPrint::private_initiate(JUTFont* font, f32 width, f32 height, JUTColor charColor, JUTColor gradColor,
                                JUTColor whiteColor, JUTColor blackColor, bool doUseFontHeight)
{
    if (!mStrBuff) {
        setBuffer(0x400);
    }
                    ...
                    bool isDrawing)
{
    ...
    JUTColor textColor     = mActiveCharColor;
    JUTColor gradientColor = mActiveGradColor;
...
u16 J2DPrint::doEscapeCode(const u8** strPtr, u8 alpha)
{
    ...
    JUTColor charColor = mActiveCharColor;
    JUTColor gradColor = mActiveGradColor;
    switch (code) {
    case 'CU': // cursor up
