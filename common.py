...
JKERNEL = JSYSTEM_BASE + [ "-O4,s", "-common on" ]
JFRAMEWORK = JSYSTEM_BASE + [ "-O4,p", "-common on" ]
...
JKERNEL_CFLAGS = ' '.join(JKERNEL + LOCAL_CFLAGS)
JSYSTEM_CFLAGS = ' '.join(JSYSTEM + LOCAL_CFLAGS)
JFRAMEWORK_CFLAGS = ' '.join(JFRAMEWORK + LOCAL_CFLAGS)
