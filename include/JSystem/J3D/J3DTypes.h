...
struct J3DBlend
{
    /** @fabricated */
    inline J3DBlend()
        : _00(j3dDefaultBlendInfo._00), _01(j3dDefaultBlendInfo._01), _02(j3dDefaultBlendInfo._02), _03(j3dDefaultBlendInfo._03)
    {
    }

    /** @fabricated */
    inline J3DBlend(const J3DBlendInfo &info)
        : _00(info._00), _01(info._01), _02(info._02), _03(info._03)
    {
    }
...
struct J3DTevOrder
{
    ...
    inline J3DTevOrder(const J3DTevOrderInfo &info)
        ...
        // , m_texMapID(info.m_texMapID)
        // , m_channelID(info.m_channelID)
        : m_texCoordID(info.m_data[0]), m_texMapID(info.m_data[1]), m_channelID(info.m_data[2])
    {
        // for (int i = 0; i < 3; i++) {
...
{
    inline J3DTexCoord()
        : _00(j3dDefaultTexCoordInfo[0]._00), _01(j3dDefaultTexCoordInfo[0]._01), _02(j3dDefaultTexCoordInfo[0]._02), _04(_02)
    {
    }

    inline J3DTexCoord(const J3DTexCoordInfo &info)
        : _00(info._00), _01(info._01), _02(info._02), _04(_02)
    {
    }
...
{
    inline J3DNBTScale()
        : _00(j3dDefaultNBTScaleInfo._00), _04(j3dDefaultNBTScaleInfo._04)
    {
