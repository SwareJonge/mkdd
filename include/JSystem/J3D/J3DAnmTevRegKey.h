...
struct J3DAnmTevRegKey : public J3DAnmBase {
    ...
    u16 getCRegAnmNum() const { return mCRegUpdateMaterialNum; }
    u16 getKRegAnmNum() const { return mKRegUpdateMaterialNum; }

    void setCRegAnmNum(u16 num) { mCRegUpdateMaterialNum = num; }
    void setKRegAnmNum(u16 num) { mKRegUpdateMaterialNum = num; }
