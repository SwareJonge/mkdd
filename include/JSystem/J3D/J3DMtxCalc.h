...
struct J3DMtxCalcMayaAdditiveAnm : public J3DMtxCalcBlendAnmBase {
    J3DMtxCalcMayaAdditiveAnm(J3DAnmTransform *);
    void calcTransform(const J3DTransformInfo &);
...
struct J3DMtxCalcBlendAnm : public J3DMtxCalcBlendAnmBase {
    inline J3DMtxCalcBlendAnm(J3DAnmTransform* anm) : _24(anm)
    {
    ...
    inline J3DMtxCalcBlendAnm(J3DAnmTransform* anm, f32 weight) : _24(anm)
    {
        mAnims[0]   = anm;
        mWeights[0] = weight;
    }
    ...
    Adaptor _24; // _24, unknown
};

struct J3DMtxCalcBlendAdaptorBase {
    J3DMtxCalcBlendAdaptorBase() {}
    void changeWgt(int, f32) {}
    void changeAnm(int, J3DAnmTransform *) {}
};

template <typename Blend, typename Scale>
struct J3DMtxCalcBlendAdaptorDefault : J3DMtxCalcBlendAdaptorBase {
    J3DMtxCalcBlendAdaptorDefault(J3DAnmTransform *anm) {}
