...
struct JPABaseParticle
{
    ...
    void setOffsetPosition(const JGeometry::TVec3f &pos) { mOffsetPosition.set(pos); }
    void setOffsetPosition(f32 x, f32 y, f32 z) { mOffsetPosition.set(x, y, z); }
    void getOffsetPosition(JGeometry::TVec3f &pos) { pos.set(mOffsetPosition); }
    u16 getRotateAngle() const { return mRotateAngle; }
    void getGlobalPosition(JGeometry::TVec3f *pos) const { pos->set(mPosition); }
    ...
    void getVelVec(JGeometry::TVec3f *vec) const { vec->set(mVelocity); }
    void getLocalPosition(JGeometry::TVec3f *vec) const { vec->set(mLocalPosition); }
