...
struct JPABaseParticle
{
	...
	JGeometry::TVec3f mGlobalPostion;  // _00
...
struct JPABaseEmitter
{
	...
	/*void setScale(f32 scaleXY, f32 scaleZ)
	{
	...
	// void setScaleOnly(f32 scale) { _98 = JGeometry::TVec3f(scale); }

	/*void setGlobalScale(f32 x, f32 y)
	{
		_B0 = x;
		_B4 = y;
	}*/
	...
	void setAngle(JGeometry::TVec3f *vec)
	{
		_18.x = vec->x;
		_18.y = vec->y;
		_18.z = vec->z;
	...
	void setScaleMain(JGeometry::TVec3f &vec)
	{
		mScale.x = vec.x;
		mScale.y = vec.y;
		mScale.z = vec.z;
	...
	/*void setScaleMain(Vector3f& vec)
	{
		mScale.x = vec.x;
		mScale.y = vec.y;
		mScale.z = vec.z;
	...
	void setScaleMain(f32 x, f32 y, f32 z)
	{
		mScale.x = x;
		mScale.y = y;
		mScale.z = z;
	...
	void setColorRGB(JUtility::TColor &color)
	{
		mColor2.r = color.r;
		mColor2.g = color.g;
		mColor2.b = color.b;
	...
	void setPrmColorRGB(JUtility::TColor &color)
	{
		mColor1.r = color.r;
		mColor1.g = color.g;
		mColor1.b = color.b;
	...
	void setPrmColorRGB(u8 r, u8 g, u8 b)
	{
		mColor1.r = r;
		mColor1.g = g;
		mColor1.b = b;
	...
	void setPrmColor(JUtility::TColor &color)
	{
	...
	u8 _44[4];								// _44
	f32 _48;								// _48
	JGeometry::TVec3<s16> _4C;				// _4C
	u16 _52;								// _52
	u16 _54;								// _54
	JSULink<JPABaseEmitter> _58;			// _58
	Mtx mMatrix;							// _68
	JGeometry::TVec3f _98;					// _98
	JGeometry::TVec3f mPosition;			// _A4
	JGeometry::TVec2f _B0;					// _B0
	JUtility::TColor mColor1;				// _B8
	JUtility::TColor mColor2;				// _BC
	u8 _C0[4];								// _C0
	JPARandom mRng;							// _C4
	JPAList<JPABaseParticle> *_C8;			// _C8
	JPAList<JPABaseParticle> *_CC;			// _CC
	s32 _D0;								// _D0
...
struct JPAEmitterWorkData
{
	...
	JPARandom mRndm;				   // _0C
	JPAVolumeCalcData mVolumeCalcData; // _10
	f32 _34;						   // _34
	f32 _38;						   // _38
	f32 _3C;						   // _3C
	...
	JGeometry::TVec3f _114;			   // _114
	JGeometry::TVec3f _120;			   // _120
	JGeometry::TVec3f _12C;			   // _120
	JGeometry::TVec3f _138;			   // _138
	JGeometry::TVec2f _144;			   // _144
	JGeometry::TVec2f _14C;			   // _14C
	Mtx _154;						   // _154
	Mtx _184;						   // _184
	Mtx _1B4;						   // _1B4
...
struct JPAEmitterManager
{
	...
	void calc();
	void draw(const JPADrawInfo *, u8 group_id);
	...
	JSUList<JPABaseEmitter> _04;		   // _04
	JPAList<JPABaseParticle> _10;
	struct JPAResourceManager **pResMgrAry; // _1C
