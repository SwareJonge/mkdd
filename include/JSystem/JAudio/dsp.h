...
typedef void (*TaskWorkCallback)(u16);
...
int DspStartWork(u32 p1, TaskWorkCallback);
...
void DwaitFrame();
void DiplSec(u32 p1, TaskWorkCallback);
void DagbSec(u32 p1, TaskWorkCallback);
void dummy_callback(u16 p1);
void DsetDolbyDelay(u32 p1, u16 p2);

void DSPReleaseHalt2(u32 msg);
u16 DSP_CreateMap2(u32 msg);
int DSPSendCommands2(u32 *msgs, u32 param_1, TaskWorkCallback);
