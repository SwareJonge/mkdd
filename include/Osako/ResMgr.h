...
namespace ResMgr { // Autogenerated
    ...
    enum ArchiveId {
        ...
        mcArcAward2D, 
        mcArcOpening,
        mcArcNone // Not sure about this one
    };
    ...
    void * getArchive(ArchiveId id) /*{ return mspaLoader[(int)id] }*/;

    /*void mspaLoader; // 0x803fe2f8
    void msaAramResArg; // 0x803fe95c
    void msCupID; // 0x80414858
    void msUsedArgArray; // 0x8041485c
    void mspKeepHeap; // 0x80416920
    void mspCourseHeap; // 0x80416924
    void mspAwardHeap; // 0x80416928
    void mspOpeningHeap; // 0x8041692c
